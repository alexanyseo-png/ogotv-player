...
Windows и Android TV используют общий eleases/latest-канал. Каждый новый Release должен содержать актуальные assets и manifests обеих платформ либо обновление одной из платформ нужно сначала перевести на отдельный канал.
